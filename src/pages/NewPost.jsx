  ...
  const handleAnalyzeClick = async () => {
    ...
    try {
      ...
      if (result.includes('Unable to analyze text')) {
        showError('AI service is temporarily unavailable. Please try again later.', 5000);
        setAnalysis('');
      } else {
        setAnalysis(result);
    ...
    <div className="container mx-auto max-w-3xl px-4 py-6">
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="content" className="mb-2 block text-lg font-medium text-gray-700 dark:text-gray-300">
              What's on your mind?
            </label>
            <div className="relative rounded-lg border border-gray-300 bg-white shadow-sm transition-all duration-200 dark:border-gray-700 dark:bg-gray-800">
              <textarea
                ref={textareaRef}
                id="content"
                rows="5"
                className="w-full resize-none rounded-lg border-0 bg-transparent p-4 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-0 dark:text-white dark:placeholder-gray-400"
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <button
              type="button"
              className="inline-flex items-center rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:text-gray-200 dark:ring-gray-600 dark:hover:bg-gray-600"
            ...
            <button
              type="submit"
              className="ml-auto inline-flex items-center rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-5 py-2.5 text-sm font-medium text-white transition-all hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70 dark:focus:ring-offset-gray-900"
      ...
      <div ref={resultsSectionRef}>
        <AnimatePresence>
          {analysis && (
            ...
            >
              <div className="mb-3 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-5 w-5 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
          ...
          {rewrittenContent && (
            ...
            >
              <div className="mb-3 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-5 w-5 text-purple-500 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button
                type="button"
                className="inline-flex items-center rounded-lg bg-gradient-to-r from-purple-500 to-blue-600 px-4 py-2 text-sm font-medium text-white shadow transition-all hover:from-purple-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
